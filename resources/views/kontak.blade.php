...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('laravel_template/css/styles.css')}}" rel="stylesheet" />
    </head>
    <body>
        <!-- Navigation-->
                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="my-5">
                            ...
                            <form id="contactForm" action="{{route('store')}}" method="POST">
                                ...
                                <div class="form-floating">
                                    <input class="form-control" id="phone" name="phone_number" type="tel" placeholder="Enter your phone number..." data-sb-validations="required" />
